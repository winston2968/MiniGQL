...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState53 : (('s, _menhir_box_main) _menhir_cell1_npattern _menhir_cell0_relspec, _menhir_box_main) _menhir_state
    (** State 53.
        Stack shape : npattern relspec.
        Start symbol: main. *)

  | MenhirState58 : (('s, _menhir_box_main) _menhir_cell1_clause, _menhir_box_main) _menhir_state
    (** State 58.
        Stack shape : clause.
        Start symbol: main. *)
...
include struct
  ...
  let _menhir_run_57 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_list_tpDecl_ -> _ -> _menhir_box_main =
  ...
  let rec _menhir_run_59 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_clause -> _ -> _menhir_box_main =
    fun _menhir_stack _v ->
  ...
  and _menhir_goto_list_clause_ : type  ttv_stack. ttv_stack -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _menhir_box_main =
    fun _menhir_stack _v _menhir_s ->
      ...
      | MenhirState58 ->
          _menhir_run_59 _menhir_stack _v
      | MenhirState34 ->
                  ...
                  | IDENTIFIER _v_0 ->
                      ...
                      | RBRACKET ->
                          ...
                          | ARROW ->
                              let _tok = _menhir_lexer _menhir_lexbuf in
                              let ident = _v_0 in
                              let _v = _menhir_action_22 ident in
  ...
  and _menhir_run_54 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_npattern _menhir_cell0_relspec -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      ...
      let np2 = _v in
      let _v = _menhir_action_18 id np1 np2 in
      _menhir_goto_pattern _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  ...
  and _menhir_goto_loption_separated_nonempty_list_COMMA_pattern__ : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_CREATE -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      ...
      | EOF ->
          ...
          _menhir_run_59 _menhir_stack _v_0
      | _ ->
          _menhir_fail ()
